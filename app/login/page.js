...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#151517] px-4 py-12">
      <div className="max-w-md w-full bg-[#1b1b1c]/80 backdrop-blur-md border border-[#25252F] rounded-2xl shadow-2xl p-6 sm:p-10">
        ...
        <div className="flex items-center gap-3 mb-6">
          <div className="relative w-10 h-10">
            <Image src={assets.logo_icon} alt="DeepSeek" fill style={{objectFit:"contain"}}/>
          </div>
        ...
        {error && <div className="text-sm text-red-500 bg-red-500/10 border border-red-500/40 p-3 rounded-md mb-4">{error}</div>}
        ...
        <div className="mt-6 text-center text-sm text-gray-400">
          ...
          <button onClick={()=>router.push("/register")} className="text-indigo-400 hover:underline">
            Sign up
          </button>
        </div>
