...
const DesktopMenu = ({setExpand}) => {
  return (
    <div className="hidden md:flex absolute top-0 w-44 gap-3 py-3 px-6 justify-between items-center ">
              <div className="logo">
                <Image
              ...
              <div className="icons flex gap-4 bg-zinc-700 w-20 py-2.5 px-2.5 rounded-3xl justify-center items-center">
                <button onClick={()=>{setExpand(true)}} className="icon1 cursor-pointer">
                    <Image
                        className="w-6 h-6"
                ...
                <button className="icon2 cursor-pointer">
                  <svg
