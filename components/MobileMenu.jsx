...
const MobileMenu = ({setExpand}) => {
  return (
    <div className=" md:hidden absolute top-0 w-full py-5 flex justify-between items-center px-5 ">
              <div onClick={()=>{setExpand(true)}} className="cursor-pointer">
                ...
                >
                  <path
                    d="M17.2028 4.90042V6.43663H2.7973V4.90042H17.2028Z"
                    fill="currentColor"
                  ></path>
                  <path
                    d="M10.9604 13.0635V14.5997H2.7973V13.0635H10.9604Z"
                    fill="currentColor"
                  ></path>
                </svg>
              </div>
